...
//Answer: Without having much experience with JS styling, probably CSS. 
...
myTd1.innerHTML = 'Name'
myTd2.innerHTML = 'Email'
myTable.append(myTr)
myTable.append(myTd1)
myTable.append(myTd2)
...
let swap = document.getElementById('word-swap')

newButton.addEventListener('click', () => {
   if (swap.innerHTML == "Hello") {
      swap.innerHTML = "World";
   } else {
      swap.innerHTML = "Hello"
   }
});
